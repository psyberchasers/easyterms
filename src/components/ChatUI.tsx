...
const ChatUI = () => {
  ...
  const handleMessageSubmit = async () => {
    ...
    const botMessage: ChatMessage = {
      ...
      message: "I'm your contract assistant. This feature is coming soon!",
      isFromUser: false,
    };
        ...
        <motion.div className="no-scroll flex h-full max-w-3xl flex-1 flex-col overflow-scroll scroll-smooth px-3 py-6">
          {chatMessages.length === 0 && (
            <div className="flex-1 flex items-center justify-center">
              <div className="text-center">
                <h2 className="text-2xl font-medium text-foreground mb-2">Contract Assistant</h2>
                <p className="text-muted-foreground">Ask questions about your contracts</p>
              </div>
            </div>
          )}
          {chatMessages.map((message, messageId) => (
            <motion.div
              ...
              key={messageId}
              className={cn(
                "my-2 w-fit max-w-xs break-words rounded-2xl px-4 py-2",
                message.isFromUser
            ...
            <div className="flex h-10 items-center justify-between px-1.5">
              <button
                ...
                className={cn(
                  ...
                  isDeepMindMode && "text-purple-500",
                )}
              >
                ...
                {isDeepMindMode ? (
                  ...
                  <span className="text-xs font-medium">Try Deep Analysis</span>
                )}
              </button>
